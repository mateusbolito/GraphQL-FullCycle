...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	courses, err := r.CourserDB.FindByCategoryID(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCategory(ctx context.Context, input model.NewCategory) (*model.Category, error) {
	category, err := r.CategoryDB.Create(input.Name, *input.Description, input.Name)
	if err != nil {
		return nil, err
	}
	return &model.Category{
...
func (r *mutationResolver) CreateCourse(ctx context.Context, input model.NewCourse) (*model.Course, error) {
	course, err := r.CourserDB.Create(input.Name, *input.Description, input.Name)
	if err != nil {
		return nil, err
	}
	return &model.Course{
...
func (r *queryResolver) Courses(ctx context.Context) ([]*model.Course, error) {
	courses, err := r.CourserDB.FindAll()
	if err != nil {
		return nil, err
	}
	var coursesModel []*model.Course
